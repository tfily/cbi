# Pack Contenu SEO (WordPress Backend)

Usage: copy/paste these texts into your `service` and `subscription` posts in WordPress.
...
- Excerpt:
`Nous gerons vos cles pour vos locations, residences secondaires ou besoins ponctuels, avec un suivi simple et fiable.`
- Content:
...
- Excerpt:
`Nous simplifions votre pressing: collecte, depot et retour selon votre planning.`
- Content:
...
- Excerpt:
`Des interventions fiables pour le bien-etre de vos animaux, meme quand vous manquez de temps.`
- Content:
...
- Excerpt:
`Optimisez vos deplacements avec un service de reservation simple et reactif.`
- Content:
...
- Excerpt:
`Un accompagnement personnalise pour retrouver du temps et de la clarte dans votre organisation.`
- Content:
`Le coaching d'organisation vous aide a clarifier vos priorites, structurer vos semaines et mettre en place des routines efficaces. Nous construisons un cadre concret, adapte a vos contraintes personnelles et professionnelles. Cette prestation est traitee sur devis apres echange initial pour definir objectifs, rythme et modalites.`
...
- Excerpt:
`La formule Premium offre une prise en charge etendue et un accompagnement haut de gamme.`

## 3) FAQ (a reutiliser dans cbi_faq_json)

```json
[
  {
    "q": "Sur quelles zones intervenez-vous ?",
    "a": "Nous intervenons principalement a Paris 6e, 7e, 15e, 17e et dans certaines communes du 92."
  },
  {
    "q": "Comment reserver un creneau ?",
    "a": "Vous choisissez votre date et votre creneau via le formulaire, puis vous recevez une confirmation."
  },
  {
    "q": "Que se passe-t-il en cas d'annulation ?",
    "a": "Selon le delai et la prestation, nous replanifions le service ou appliquons les conditions prevues."
  },
  {
    "q": "Les paiements sont-ils securises ?",
    "a": "Oui, les paiements en ligne sont traites via une passerelle securisee."
  }
]
```

## 4) Posts "Actualites" a publier (pour remplacer Hello World)

### Post 1
- Title: `Nouveaux creneaux disponibles du lundi au vendredi`
- Excerpt: `Nos interventions sont desormais proposees de 8h a 20h sur les jours ouvres, selon disponibilite.`

### Post 2
- Title: `Comment preparer une demande de conciergerie efficace`
- Excerpt: `Indiquez date, creneau, adresse et besoin precis pour accelerer la prise en charge.`
